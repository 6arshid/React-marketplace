...
class StoreController extends Controller
{
    public function profile(User $user): Response
    {
        ...
        return Inertia::render('Store/Profile', [
            'user' => $user->only('id', 'name', 'username', 'logo', 'cover', 'about', 'whatsapp_number', 'telegram_username', 'instagram_username', 'facebook_username', 'public_email', 'footer_text', 'suspended_at'),
            'pages' => $pages,
