        ...
        >
            ...
            <div className="py-6 sm:py-8">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        {filteredProducts.length === 0 ? (
                            ...
                            <div className="block sm:hidden">
                                {paginatedProducts.map((p) => (
                                    <div key={p.id} className="border-b border-gray-100 p-4 hover:bg-gradient-to-r hover:from-blue-50/50 hover:to-indigo-50/30 transition-all duration-300">
                    ...
                    {/* Statistics Footer */}
                    {filteredProducts.length > 0 && (
                        <div className="mt-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 sm:p-6">
