...
const TrackingIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
const CurrencyIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M11.8 10.9c-2.27-.59-3-1.2-3-2.15 0-1.09 1.01-1.85 2.7-1.85 1.78 0 2.44.85 2.5 2.1h2.21c-.07-1.72-1.12-3.3-3.21-3.81V3h-3v2.16c-1.94.42-3.5 1.68-3.5 3.61 0 2.31 1.91 3.46 4.7 4.13 2.5.6 3 1.48 3 2.41 0 .69-.49 1.79-2.7 1.79-2.06 0-2.87-.92-2.98-2.1h-2.2c.12 2.19 1.76 3.42 3.68 3.83V21h3v-2.15c1.95-.37 3.5-1.5 3.5-3.55 0-2.84-2.43-3.81-4.7-4.4z"/>
    </svg>
);

const SellerIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z"/>
    </svg>
);

const ShippingIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
...
const ViewIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z"/>
    </svg>
);

const DigitalIcon = ({ className = "w-3 h-3 sm:w-4 sm:h-4" }) => (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
            ...
            header={
                <div className="flex items-center space-x-2 sm:space-x-3">
                    <div className="p-1.5 sm:p-2 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg">
                        <OrderIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white" />
                    </div>
                    <div>
                        <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{t('Orders')}</h2>
                        <p className="text-xs sm:text-sm text-gray-600 hidden sm:block">{t('Track and manage your order history')}</p>
                    </div>
                </div>
            }
        >
            ...
            <div className="py-4 sm:py-8">
                <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6 sm:mb-8 grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
                        <div className="relative overflow-hidden rounded-lg sm:rounded-xl bg-white p-3 sm:p-6 shadow-sm ring-1 ring-gray-200">
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                <div className="flex-shrink-0 mb-2 sm:mb-0">
                                    <div className="rounded-lg bg-blue-100 p-2 sm:p-3">
                                        <OrderIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-blue-600" />
                                    </div>
                                </div>
                                <div className="sm:ml-4 min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{t('Total Orders')}</p>
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{totalOrders}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                <div className="flex-shrink-0 mb-2 sm:mb-0">
                                    <div className="rounded-lg bg-green-100 p-2 sm:p-3">
                                        <CurrencyIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-green-600" />
                                    </div>
                                </div>
                                <div className="sm:ml-4 min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{t('Total Spent')}</p>
                                    <p className="text-sm sm:text-lg lg:text-xl xl:text-2xl font-bold text-gray-900">{formatAmount(totalAmount)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden rounded-lg sm:rounded-xl bg-white p-3 sm:p-6 shadow-sm ring-1 ring-gray-200">
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                ...
                                <div className="sm:ml-4 min-w-0 flex-1">
                                    ...
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{completedOrders}</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center">
                                <div className="flex-shrink-0 mb-2 sm:mb-0">
                                    <div className="rounded-lg bg-orange-100 p-2 sm:p-3">
                                        <DigitalIcon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-orange-600" />
                                    </div>
                                </div>
                                <div className="sm:ml-4 min-w-0 flex-1">
                                    <p className="text-xs sm:text-sm font-medium text-gray-600 truncate">{t('Digital Items')}</p>
                                    <p className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{digitalOrders}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="overflow-hidden bg-white shadow-lg sm:shadow-xl rounded-lg sm:rounded-2xl ring-1 ring-gray-200">
                        <div className="px-4 sm:px-6 py-4 border-b border-gray-200">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
                                <h3 className="text-base sm:text-lg font-semibold text-gray-900">{t('Order History')}</h3>
                        ...
                        <div className="lg:hidden">
                            {paginatedOrders.length > 0 ? (
                                        ...
                                        <div key={order.id} className="p-4 hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center space-x-1">
                                                        {order.is_digital ? (
                                                            <>
                                                                <DigitalIcon className="w-3 h-3 text-green-500" />
                                                            ...
                                                            <>
                                                                <ShippingIcon className="w-3 h-3 text-blue-500" />
                                                                <span className="text-xs font-mono text-gray-900 bg-blue-50 px-1 py-0.5 rounded">
                                                                    {order.postal_tracking_code}
                                                                </span>
                                                            </>
                                                        ) : (
                                            ...
                                            <div className="mt-3 pt-3 border-t border-gray-100">
                                                <Link 
                                                    ...
                                                    className="inline-flex items-center w-full justify-center px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors duration-200 space-x-2"
                                                >
                                                    <ViewIcon />
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-base font-medium text-gray-900 mb-2">{t('No orders found')}</h3>
                                    <p className="text-sm text-gray-500 mb-4">{t("You haven't placed any orders yet.")}</p>
                                    <button className="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors duration-200 text-sm">
                                        {t('Start Shopping')}
                                    </button>
                                </div>
                            )}
                        ...
                        <div className="hidden lg:block overflow-x-auto">
                                    ...
                                    {paginatedOrders.map((order) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                                                <div className="flex items-center space-x-2">
                                                    {getStatusIcon(order.status)}
                                                    <span className={`inline-flex items-center px-2 lg:px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(order.status)}`}>
                                                        {order.status.charAt(0).toUpperCase() + order.status.slice(1)}
                                                    </span>
                                                </div>
                                            </td>
                                            <td className="px-4 xl:px-6 py-3 xl:py-4 whitespace-nowrap">
                                                <div className="flex items-center space-x-2">
                                                    <div className="w-6 h-6 lg:w-8 lg:h-8 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold">
                                                        {order.seller.name.charAt(0).toUpperCase()}
                                                    </div>
                            ...
                            {filteredOrders.length === 0 && (
                                <div className="text-center py-16">
                                    <div className="mx-auto w-20 h-20 lg:w-24 lg:h-24 bg-gray-100 rounded-full flex items-center justify-center mb-4">
                                        <OrderIcon className="w-10 h-10 lg:w-12 lg:h-12 text-gray-400" />
                                    </div>
                                    <h3 className="text-lg lg:text-xl font-medium text-gray-900 mb-2">{t('No orders found')}</h3>
