            ...
            <div className="py-8">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="relative overflow-hidden rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-200 sm:col-span-2 lg:col-span-1">
                            <div className="flex items-center">
                                <div className="flex-shrink-0">
                                                    ...
                                                    <div className="flex items-start space-x-3">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center justify-between">
                                                                ...
                                                                <ExternalLinkIcon className="w-4 h-4 text-gray-400 group-hover:text-indigo-500 transition-colors" />
                                                            </div>
