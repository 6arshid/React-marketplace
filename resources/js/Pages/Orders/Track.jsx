            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12">
                <div className="mx-auto max-w-4xl px-6 lg:px-8">
                    ...
                    <div className="mb-8 text-center">
                        ...
                        <p className="mt-2 text-gray-600">Track your order status and download files</p>
                    </div>
                    ...
                    <div className="mb-8 overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-200">
                        ...
                        <div className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    <p className="text-sm font-medium text-gray-600">Tracking Code</p>
                    ...
                    {order.postal_tracking_code && (
                        <div className="mb-8 overflow-hidden rounded-2xl bg-white shadow-xl ring-1 ring-gray-200">
                            ...
                            <div className="p-6">
                                <div className="flex items-center space-x-3">
                                    <p className="text-sm font-medium text-gray-600">Postal Tracking Code:</p>
                                ...
                                <p className="mt-2 text-sm text-gray-600">
                                    Use this code to track your package with the shipping carrier.
                                </p>
                            </div>
                        </div>
                    )}
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-600">{files.length} file{files.length !== 1 ? 's' : ''} ready for download</p>
                                        </div>
                                    </div>
