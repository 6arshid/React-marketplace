...
export default function Create() {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">New Page</h2>}>
            <Head title="New Page" />
            <div className="py-8">
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="space-y-6" encType="multipart/form-data">
                        ...
                        <div className="flex justify-between">
                            <Link href={route('admin.pages.index')} className="text-gray-600 hover:underline">Cancel</Link>
