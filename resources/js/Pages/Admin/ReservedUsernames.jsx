...
export default function ReservedUsernames({ reservedUsernames }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Reserved Usernames</h2>}>
                ...
                <div className="mx-auto max-w-7xl space-y-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white p-4 shadow sm:rounded-lg">
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    <th className="px-3 py-2 text-left text-sm font-semibold text-gray-700">Username</th>
                                ...
                                {reservedUsernames.map((u) => (
                                    <tr key={u.id}>
                                        ...
                                        <td className="px-3 py-2 text-right">
                                            <button onClick={() => deleteUsername(u.id)} className="text-red-600 hover:underline">Delete</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
