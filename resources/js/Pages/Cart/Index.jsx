...
export default function Index({ items, total, discount, voucher_discount, coupon, voucher, seller, requires_shipping }) {
                    ...
                    <div className="backdrop-blur-sm bg-white/80 rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
                        <div className="p-8">
                            ...
                            {step === 1 && (
                                <div className="space-y-6 animate-fade-in">
                                    <div className="text-center">
                                        <h3 className="text-2xl font-semibold text-gray-800 mb-2">{t('Review Your Order')}</h3>
                                        <p className="text-gray-600">{t('Check your items before proceeding')}</p>
                                    </div>
                                    ...
                                    {items.length ? (
                                           ...
                                           <form
                                            ...
                                            <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-6 text-white space-y-2">
                                                ...
                                                {voucher_discount > 0 && (
                                                    <div className="flex justify-between items-center text-sm">
                                                        <span>{t('Voucher')}</span>
                                                        <span>- ${voucher_discount.toFixed(2)}</span>
                                                    </div>
                                                )}
                                                <div className="flex justify-between items-center">
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-xl text-gray-600">{t('Your cart is empty')}</p>
                                            <p className="text-gray-500 mt-2">{t('Add some items to get started')}</p>
                                        </div>
                                    )}
                                    ...
                                    {items.length > 0 && (
                                        <div className="text-center pt-6">
                                            ...
                                            >
                                                {t('Continue to')} {requires_shipping ? t('Shipping') : t('Payment')}
                                ...
                                <div className="space-y-6 animate-fade-in">
                                    <div className="text-center">
                                        <h3 className="text-2xl font-semibold text-gray-800 mb-2">
                                            {requires_shipping ? t('Shipping Information') : t('Almost There!')}
                                        </h3>
                                        <p className="text-gray-600">
                                            {requires_shipping ? t('Please provide your delivery details') : t('Ready to proceed to payment')}
                                        </p>
                                    </div>
                                    ...
                                    {requires_shipping ? (
                                        ...
                                        <div className="text-center py-12">
                                            ...
                                            <p className="text-xl text-gray-700">{t('No shipping required')}</p>
                                            <p className="text-gray-500 mt-2">{t('Digital products will be delivered instantly')}</p>
                                        </div>
                                    )}
                            ...
                            {step === 3 && items.length > 0 && (
                                <div className="space-y-6 animate-fade-in">
                                    <div className="text-center">
                                        <h3 className="text-2xl font-semibold text-gray-800 mb-2">{t('Payment Options')}</h3>
                                        <p className="text-gray-600">{t('Choose your preferred payment method')}</p>
                                    </div>
                                            ...
                                            {seller?.trc20_usdt_wallet && (
                                                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-100">
                                                    <div className="text-center">
                                                        ...
                                                        <h4 className="font-semibold text-gray-800 mb-2">{t('USDT Payment')}</h4>
                                            ...
                                            {seller?.bitcoin_wallet && (
                                                <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-100">
                                                    <div className="text-center">
                                                        ...
                                                        <h4 className="font-semibold text-gray-800 mb-2">{t('Bitcoin Payment')}</h4>
                                    ...
                                    {(user?.trc20_usdt_wallet || user?.bitcoin_wallet) && (
                                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-gray-100">
                                            <h4 className="font-semibold text-gray-800 mb-4 text-center">{t('Your Transaction Details')}</h4>
                                    ...
                                    <div className="text-center">
                                        ...
                                        >
                                            ...
                                            {t('Pay {{amount}} with Stripe', { amount: total })}
                                        </button>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        >
                                            ...
                                            {t('Back to')} {requires_shipping ? t('Shipping') : t('Previous Step')}
                                        </button>
                                    </div>
                                </div>
                            )}
